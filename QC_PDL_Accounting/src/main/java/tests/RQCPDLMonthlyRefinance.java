...
public class RQCPDLMonthlyRefinance extends QCStore{
...
//===================================================================================
				...
				if (ProvidedPrincpleBalance.equals(PrincleBalance)){
					...
					test.log(LogStatus.PASS, "<FONT color=green style=Arial>Princple Balance->Expected value:"+ProvidedPrincpleBalance +"; == Actual value:"+PrincleBalance );
				}
				else{
					test.log(LogStatus.FAIL, "Princple Balance->Expected value:"+ProvidedPrincpleBalance +"; not equals to Actual value:"+PrincleBalance);
				}	
